        ...
        <div class="col-md-12 grid-margin">
          <div class="row">
            <div class="col-12 col-xl-8 mb-4 mb-xl-0">
              <h3 class="font-weight-bold">{{__('sunshine.welcome')}} {{$user->staff->full_name}}</h3>
            ...
            <div class="col-md-6 mb-4 stretch-card transparent">
              <div class="card card-tale">
                <div class="card-body">
                  ...
                  <input type="text" value="8:00" name="first_checkin">
                  <p>Sớm nhất</p>
                </div>
              </div>
            </div>
            <div class="col-md-6 mb-4 stretch-card transparent">
              <div class="card card-dark-blue">
                <div class="card-body">
                  ...
                  <input type="text" value="17:30" name="last_checkout">
                  <p>Muộn nhất</p>
                </div>
              </div>
            </div>
