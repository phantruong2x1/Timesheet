...
<div class="card-body">
    ...
    <form class="forms-sample" action="{{route('users.post-edit')}}" method="POST">
    @csrf     
        {{-- staff_id --}}
        <div class="form-group row">
            ...
            <select class="form-control" name="staff_id" value="{{old('staff_id')}}">
                ...
                <option value="{{$item->id}}"
                    ...
                    @if($userDetail->staff_id == $item->id)
                    selected
                    @endif
        ...
        <div class="form-group row">
            ...
            name="user_name"  value="{{old('user_name') ?? $userDetail->user_name}}">
